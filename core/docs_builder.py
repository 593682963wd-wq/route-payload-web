...
INTRO_BULLETS = [
    ...
    "自动按航线（起飞-目的-线路）分组，同航线下按机型 A319 → A320-214 → A320-214W → A320-251 → A321-211 顺序汇总",
...
def build_manual_bytes() -> bytes:
    ...
    _para(doc, "• 大标题下按机型 A319-115 → A320-214 → A320-214W → A320-251 → A321-211 顺序排列各机型表格")
    _para(doc, "• 航线大标题按往返配对排序：A→B 之后紧邻 B→A（同线路后缀）")
    _para(doc, "• 各机型核定最大载客人数：A319-115=144，A320-214=180，A320-214W=186，A320-251=186，A321-211=220；超出按上限封顶")
    ...
    _slide_section_bullets(prs, total, 4, "02", "核心功能特性", [
        ...
        ("🧭", "智能分组",
         ["按起飞-目的-线路自动归类",
          ...
          "同航线汇总到一个标题"]),
        ("🛩", "机型分层",
         ["A319 → A320-214 → A320-214W → A320-251 → A321-211",
          "顺序固定，输出统一",
          "未识别机型可补充映射"]),
        ("📄", "Word 一键导出",
         ["纵向 A4，宋体",
